...
class XarBuilderTest(xar_test_helpers.XarTestCase):
    def setUp(self):
        ...
        for filename, data, mode, permissions in self.files.values():
            ...
            self.assertEqual(xar_test_helpers.mode(self.src.absolute(filename)),
                             permissions)
    ...
    def test_set_executable(self):
        ...
        self.assertEqual("#!/usr/bin/env xarexec", self.xar_builder._shebang)
    ...
    def test_build(self):
        ...
        self.xar_builder.build(test_xar)
